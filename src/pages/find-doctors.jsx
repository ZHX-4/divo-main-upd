...
const mockDoctors = [
  ...
  },
  {
    ...
    insurances: ['Cigna', 'UnitedHealthcare', 'Humana'],
    acceptingNewPatients: true,
  ...
  },
  {
    ...
    insurances: ['Aetna', 'Blue Cross Blue Shield', 'UnitedHealthcare', 'Medicaid'],
    acceptingNewPatients: true,
  ...
  },
  {
    ...
    insurances: ['Medicare', 'Blue Cross Blue Shield', 'Cigna'],
  ...
  },
  {
    ...
    insurances: ['Blue Cross Blue Shield', 'Medicare', 'Humana'],
    acceptingNewPatients: true,
